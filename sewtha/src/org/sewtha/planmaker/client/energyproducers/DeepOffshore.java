...
public class DeepOffshore extends EnergyProducerOrConsumer {
	...
	public String getDescription() {
		return "Offshore Wind Farms (Deep)";
	}
	...
	public double get2006KWHdp(){
		return geog.get2006DeepOffWindKWHdp();
	}
	
	public double get2006KWHdpMetric(){
		return geog.getDeepWind2006Metric();
	}
	...
	public String getQuestionForChange() {
		return "Please choose the percentage of all available seabed to use for Deep Offshore Wind Farms.";
	}
	...
	private void calculateNewKWHdp() {
		...
		double offshoreArea = geog
				.getAvailableAreaForDeepOffshoreKmSquared();
		double ratioToKm = NaturalConstants.RATIO_KM_SQUARED_TO_METRE_SQUARED;
		// this is strange - this equation does not work below
		double t = geog.getAvailableAreaForShallowOffshoreKmSquared()
	...
	public String getTodayEquivalentStr() {
		...
		String s = getNumberFormat().format(
				(geog.get2006DeepOffWindKWHdp() / geog.getWindTurbineKWhdp()));
		return s;
	}
